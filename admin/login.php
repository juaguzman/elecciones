	...
	<thead>
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td><a href="#" onclick="Eliminar (<?php echo $campos->idcandidatos; ?>)"><img src="../img/mdf.png" width="25px" heigt="25px"></a></td>
                    <td><a href="#" onclick="Modificar (<?php echo $campos->idcandidatos; ?>)"><img src="../img/elmn.png" width="25px" heigt="25px"></a></td>  
		</tr>
                <?php }?>
	</tbody>
    </table>
